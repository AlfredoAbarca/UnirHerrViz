...
function Carga_Grafico_Defunciones() {
  ...
  d3.csv(
    "https://raw.githubusercontent.com/AlfredoAbarca/UnirHerrViz/main/Tarea_1/data/All_MX_Covid_Sumarized.csv",
  ...
  d3.csv(
    ...
    (d) => {
      return {
        ...
        Casos_Confirmados: d.Tasa_de_Contagio,
      };
    }
  ).then(
    ...
    function (data) {
      ...
      const brush = d3
        ...
        .extent([
          [0, 0],
          [width, height],
        ]) // Se inicializa el pbjeto de brush con los parametros 0,0 que significa que podremos seleccionar el area completa.
      ...
      Create_Html_Table("#Grafica1_Tabla", data, [
        "Fecha",
        "Casos_Confirmados",
      ]);
    }
...
function Carga_Grafico_Estados_Anio() {
  ...
  var svg = d3
    .select("#grafica_anio_edo_contagios")
    .append("svg")
    .attr("width", width + margin.left + margin.right)
    .attr("height", height + margin.top + margin.bottom)
    .append("g")
  ...
  d3.csv(
    "https://raw.githubusercontent.com/AlfredoAbarca/UnirHerrViz/main/Tarea_1/data/All_MX_Covid_x_AnioEstado.csv"
  ).then(function (data) {
    ...
    Create_Html_Table("#Grafica4_Tabla", temp_data, [
      "Year",
      "Estado",
      "Casos_Confirmados",
    ]);
    ...
    d3.select("#select_year_Button")
      ...
      .text(function (d) {
        return d;
      }) //Se muestra la opcion de defecto
      .attr("value", function (d) {
        return d;
      }); // El atributo de valor, almacenara el valor seleccionado en la caja desplegable
    ...
    const tooltip = d3
      .selectAll("#grafica_anio_edo_contagios")
      .append("div")
      .style("opacity", 0)
      .attr("class", "tooltip")
    ...
    function update(selectedGroup) {
      ...
      svg
        ...
        .attr("y", function (d) {
          return y(d.Casos_Confirmados);
        })
        .attr("width", x.bandwidth())
        .attr("height", function (d) {
          return height - y(d.Casos_Confirmados);
        });
...
function Carga_Grafico_Estados_Def() {
  ...
  d3.csv(
    ...
    Create_Html_Table("#Grafica6_Tabla", temp_data, [
      "Year",
      "Estado",
      "Defunciones",
    ]);
    ...
    const tooltip = d3
      .selectAll("#grafica_anio_edo_def")
      .append("div")
      .style("opacity", 0)
      .attr("class", "tooltip")
      .style("background-color", "white")
    ...
    function update(selectedGroup) {
      ...
      svg
        ...
        .attr("y", function (d) {
          return y(d.Defunciones);
        })
        .attr("width", x.bandwidth())
        .attr("height", function (d) {
          return height - y(d.Defunciones);
        });
      ...
      if (selectedGroup == 2021) {
        bars.attr("fill", "purple");
      }
      if (selectedGroup == 2022) {
        bars.attr("fill", "brown");
      }
    }
...
function Carga_Grafico_Vacunas() {
  ...
  d3.csv(
    "https://raw.githubusercontent.com/AlfredoAbarca/UnirHerrViz/main/Tarea_1/data/Covid_vaccinations_MX.csv",
...
function Carga_Grafico_Movilidad() {
  ...
  d3.csv(
    "https://raw.githubusercontent.com/AlfredoAbarca/UnirHerrViz/main/Tarea_1/data/MX_Region_Mobility_Report.csv",
...
function formatDate(date) {
  ...
  return d3.timeParse("%Y-%m-%d")([year, month, day].join("-"));
}
