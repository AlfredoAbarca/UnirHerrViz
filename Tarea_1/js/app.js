...
function Carga_Grafico_Estados_Anio() {
  ...
  d3.csv("https://raw.githubusercontent.com/AlfredoAbarca/UnirHerrViz/main/Tarea_1/data/All_MX_Covid_x_AnioEstado.csv").then( 
    function(data) {
      ...
      const mouseover = function(event, d) {
        ...
        tooltip.html('Casos: ' + d3.format(",")(d.Casos_Confirmados)).style('opacity', 100);
